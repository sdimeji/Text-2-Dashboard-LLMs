...
if not api_key:
    st.error("Missing OPENAI_API_KEY. Set it in the terminal before starting the app.")
    st.stop()

st.set_page_config(page_title="Dashboard Query Based Analytics")
...
st.title("Dashboard Query Based Analytics")
